...
from stonks.session.schemas import SessionState, Watchlist, Position, Portfolio, Preferences, DecisionRecord, Alert, TradingStyle, RiskProfile
from stonks.session.persistence import PersistenceManager
from stonks.session.watchlist import WatchlistService
from stonks.session.positions import PositionService
from stonks.session.portfolio import PortfolioService
from stonks.session.history import HistoryService
from stonks.session.alerts import AlertService
from stonks.session.preferences import PreferencesService
from stonks.session.exceptions import InvalidStateError
...
class TradingSessionManager:
    ...
    def set_cash_balance(self, amount: float) -> None:
        self._ensure_session()
        self.state.portfolio.cash_balance = amount
        self.portfolio_service.update_portfolio_metrics(self.state)
        self.save_session()
